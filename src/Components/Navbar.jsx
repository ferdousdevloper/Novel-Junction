...
const Navbar = () => {
    ...
    const links = <>
        ...
        <li><NavLink to='/' className={({ isActive }) =>
                      isActive ? "text-[#23BE0A] font-bold border  border-[#23BE0A] mr-3" : "font-bold mr-3"
                    }>Home</NavLink></li>
    ...
    <div>
      <div className="navbar ">
        <div className="navbar-start">
          ...
          <a className=" text-3xl font-bold text-[#131313]">Novel <span className="text-[#23BE0A]">Junction</span></a>
        </div>
